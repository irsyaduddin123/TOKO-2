            ...
            <div id="content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3 col-sm-4">
                        ...
                        <input type="text" id="konsumen" class="form-control" aria-label="Username" aria-describedby="basic-addon1"  value="<?php echo date('YmdHis'); ?>">
                    </div>
                        ...
                        <div class="input-group mb-3 col-sm-4">
                            ...
                            <!-- <div class="col-sm-4"> -->
                                ...
                                if (mysqli_num_rows($resultKar) > 0) {
                                    ...
                                    echo "<option value=" . $row["namakar"] . ">" . $row["namakar"] . "</option>";
                                    }
                                } 
                                ?>
                                </select>
                            ...
                            <div class="input-group mb-3 col-sm-4">
                                ...
                                <span class="input-group-text" >Supplier</span>
                                    ...
                                    include 'koneksi.php';
                                    $sqla = "select * from supplier";
                                    $resultsp =  mysqli_query($conn,$sqla);
                                    if (mysqli_num_rows($resultsp) > 0) {
                                        while ($rowa = mysqli_fetch_assoc($resultsp)) {
                                        echo "<option value=" . $rowa["nama"] . ">" . $rowa["nama"] . "</option>";
                                        //echo "<option value=" . $rowa["perusahaan"] . ">" . $rowa["perusahaan"] . "</option>";
                                        }
                                    } 
                                    ?>
                                    </select>
...
//FUNGSI GET TGL DAN KODE
  ...
  //------------------ FUNGSI UBAH BARANG
      ...
      //telephone
    //   $("#suppli").on("click", ".tambahpilih", function () {
    //     var id = $(this).attr("id");
    //     console.log(id);
    ...
    //------------REMOVE DARI TABEL
      ...
      $("#savemasterdetail").click(function () {
        ...
        let kodeps1 = <?php echo date('YmdHis');  ?>;
        ...
        $("#tbody tr").each(function () {
          ...
          console.log(kodeps1);
          console.log(hargabeli1);
          console.log(jumlah1);

          $.post("simpandetailpesanan.php",{kodeps:kodeps1,kodebr:kodebr1,
            hargabeli:hargabeli1,jumlah:jumlah1
       ...
       {    
        ...
        $.post("simpanpesanan.php",{kodeps:kodeps1,tanggal:tanggal1,
            supplier:supplier1,keterangan:keterangan1,karyawan:karyawan1,total:total1
        },function(data,status)
       {
         alert("sukses");    
         $('#isi').load("tabelpemesanan.php");
